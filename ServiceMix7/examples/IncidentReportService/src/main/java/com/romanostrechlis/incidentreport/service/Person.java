...
public interface Person {
    ...
    @RequestWrapper(localName = "GetPerson", className = "com.romanostrechlis.incidentreport.service.types.GetPerson")
    @ResponseWrapper(localName = "GetPersonResponse", className = "com.romanostrechlis.incidentreport.service.types.GetPersonResponse")
